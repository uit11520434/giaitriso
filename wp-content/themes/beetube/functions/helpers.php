 ...
 *
 *  @package jtheme Framework
 * @subpackage Functions
 */

function jtheme_dir_path( $file = '' ) {
	$dir = dirname($file) ;
...
function jtheme_dir_url( $file = '' ) {
	$dir = jtheme_dir_path( $file );
...
function jtheme_dir2url( $path = '', $dir = '' ) {
	if( !$dir )
		$dir = __FILE__;
...
function relative_time( $from, $to = '', $limit = 1 ) {
	...
	$units = apply_filters( 'time_units', array(
			31556926 => array( __('%s year', 'jtheme'),  __('%s years', 'jtheme') ),
			2629744  => array( __('%s month', 'jtheme'), __('%s months', 'jtheme') ),
			604800   => array( __('%s week', 'jtheme'),  __('%s weeks', 'jtheme') ),
			86400    => array( __('%s day', 'jtheme'),   __('%s days', 'jtheme') ),
			3600     => array( __('%s hour', 'jtheme'),  __('%s hours', 'jtheme') ),
			60       => array( __('%s min', 'jtheme'),   __('%s mins', 'jtheme') )
	) );
	...
	$seperator = _x( ', ', 'human_time_diff', 'jtheme' );
